...
function initMap() {
      ...
      //文字列
      var contentString = '<div id="content"><h2 id="firstHeading" class="firstHeading">オペラハウス</h2><dl><dt>その地点に関する説明</dt><dd>オペラハウスはオーストラリアのシドニーにある建築物である。2007年に世界文化遺産に登録された。完成まで14年かかった。近くにはハーバーブリッジという、とても大きな橋がある。</dd><dt>興味をもった理由</dt><dd>高校生の時に初めて海外であるオーストラリアに行った。オペラハウスは屋根の形がとても特徴的で、1番印象に残っているから。近くに大きな橋があるが、日本で見たことがある橋よりもとても大きくて驚いた。海外に行けるようになったら、また行きたいと思っている。</dd></dl></div>';
